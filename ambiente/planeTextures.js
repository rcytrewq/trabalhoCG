...
var camera = new THREE.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 0.1, 1000);
  camera.lookAt(0, 0, 0);
  camera.position.set(30.8, 26.2, 56.1);
  camera.up.set( 0, 1, 0 );
...
assembledAirplane.position = new THREE.Vector3(0,0,0)
scene.add(assembledAirplane);
...
function createFuselage(cube){
  ...
  cockpitBase.material.map = wall01;
...
function createLandingGear(){
 ...
 function airplaneAssembly (cube, inspection){
